 ...
 * Author: nghia
 *
 * Created on December 4, 2020, 8:18 PM
 * 
 * Name: Nghia Lam
 * UTA ID: 1001699317
 */
 ...
 /*
  * Lab4Part1a:  Address all of the elements below to change the given code
  * Meaningful names - Replace generic / meaningless variable and function names with meaningful names
  * Hard coded numbers 
  ...
  * Formatting and indentation - Use the notes in the code to modify the code so that formatting and indentation is consistent throughout whole program
...
double tS(double details[MAXGIFTS][MAXNUMS], int row)  
{
    ...
    // What is n calculating?  What should be done with the value of n?
